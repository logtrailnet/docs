---
name: logtrail-api
description: Integration guide for the Logtrail Workspace API. Use when Gemini CLI needs to ingest logs, query log data, or configure Logtrail SDKs in a project.
---
